...
export class InputAggregator
{
    ...
    computeMovement(): MovementInput
    {
        ...
        {
            const moveX =
                (this.activeKeys.has("d") || this.activeKeys.has("arrowright") ? 1 : 0) +
                        (this.activeKeys.has("a") || this.activeKeys.has("arrowleft") ? -1 : 0) as
                    - 1 |
                0 | 1;
            const moveZ =
                (this.activeKeys.has("w") || this.activeKeys.has("arrowup") ? 1 : 0) +
                        (this.activeKeys.has("s") || this.activeKeys.has("arrowdown") ? -1 : 0) as
                    - 1 |
                0 | 1;
        ...
        {
            const moveX = this.activeRadialDirection === "right"  ? 1
                          : this.activeRadialDirection === "left" ? -1
                                                                  : 0 as - 1 | 0 | 1;
            const moveZ = this.activeRadialDirection === "down" ? -1
                          : this.activeRadialDirection === "up" ? 1
                                                                : 0 as - 1 | 0 | 1;
