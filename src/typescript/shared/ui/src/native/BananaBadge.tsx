...
export function BananaBadge(props: BananaBadgeProps) {
    ...
    return (
        <View
            ...
            <Text style={{ fontSize: tokens.font.size.xs, fontWeight: tokens.font.weight.semibold, color: tokens.color.banana.fg }}>
                🍌 {count}
            </Text>
            {children ? (
                <Text style={{ fontSize: tokens.font.size.xs, color: tokens.color.banana.fg }}>{children}</Text>
            ) : null}
        </View>
    );
}
...
function EnsembleBadge({ verdict, showAttention, children }: EnsembleVariantProps) {
    ...
    return (
        <View
            ...
            <Text style={{ fontSize: tokens.font.size.xs, fontWeight: tokens.font.weight.medium, color: tone.fg }}>
                🍌 {labelText}
            </Text>
            <Text testID="banana-badge-ensemble-magnitude" style={{ fontSize: tokens.font.size.xs, color: tone.fg, opacity: 0.75 }}>
                m={magnitude}
            </Text>
