...
var BananaEngine = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var setMainLoop = (iterFunc, fps, simulateInfiniteLoop, arg, noSetTiming) => {
      assert(
        !MainLoop.func,
        "emscripten_set_main_loop: there can only be one main loop function at once"
      );
    ...
    var GL = {
      ...
      preDrawHandleClientVertexAttribBindings: (count) => {
        ...
        for (var i = 0; i < GL.currentContext.maxVertexAttribs; ++i) {
          ...
          assert(
            count || !GLctx.currentElementArrayBufferBinding,
            "must use array buffers when using element buffer"
          );
    ...
    var _engine_world_spawn = (Module["_engine_world_spawn"] =
      makeInvalidEarlyAccess("_engine_world_spawn"));
    var _engine_controller_attach = (Module["_engine_controller_attach"] = makeInvalidEarlyAccess(
      "_engine_controller_attach"
    ));
    var _engine_controller_signal = (Module["_engine_controller_signal"] = makeInvalidEarlyAccess(
      "_engine_controller_signal"
    ));
    var _engine_get_entity_count = (Module["_engine_get_entity_count"] = makeInvalidEarlyAccess(
      "_engine_get_entity_count"
    ));
    var _engine_get_entity_x = (Module["_engine_get_entity_x"] =
      makeInvalidEarlyAccess("_engine_get_entity_x"));
    var _engine_get_entity_z = (Module["_engine_get_entity_z"] =
      makeInvalidEarlyAccess("_engine_get_entity_z"));
    var _engine_get_entity_state = (Module["_engine_get_entity_state"] = makeInvalidEarlyAccess(
    ...
    function assignWasmExports(wasmExports) {
      assert(typeof wasmExports["engine_tick"] != "undefined", "missing Wasm export: engine_tick");
      assert(
        typeof wasmExports["engine_world_spawn"] != "undefined",
        "missing Wasm export: engine_world_spawn"
      );
      assert(
        typeof wasmExports["engine_controller_attach"] != "undefined",
        "missing Wasm export: engine_controller_attach"
      );
      assert(
        typeof wasmExports["engine_controller_signal"] != "undefined",
        "missing Wasm export: engine_controller_signal"
      );
      assert(
        typeof wasmExports["engine_get_entity_count"] != "undefined",
        "missing Wasm export: engine_get_entity_count"
      );
      assert(
        typeof wasmExports["engine_get_entity_x"] != "undefined",
        "missing Wasm export: engine_get_entity_x"
      );
      assert(
        typeof wasmExports["engine_get_entity_z"] != "undefined",
        "missing Wasm export: engine_get_entity_z"
      );
      assert(
        typeof wasmExports["engine_get_entity_state"] != "undefined",
        "missing Wasm export: engine_get_entity_state"
      );
      ...
      _engine_tick = Module["_engine_tick"] = createExportWrapper("engine_tick", 1);
      _engine_world_spawn = Module["_engine_world_spawn"] = createExportWrapper(
        "engine_world_spawn",
        4
      );
      _engine_controller_attach = Module["_engine_controller_attach"] = createExportWrapper(
        "engine_controller_attach",
        2
      );
      _engine_controller_signal = Module["_engine_controller_signal"] = createExportWrapper(
        "engine_controller_signal",
        2
      );
      _engine_get_entity_count = Module["_engine_get_entity_count"] = createExportWrapper(
        "engine_get_entity_count",
        0
      );
      _engine_get_entity_x = Module["_engine_get_entity_x"] = createExportWrapper(
        "engine_get_entity_x",
        1
      );
      _engine_get_entity_z = Module["_engine_get_entity_z"] = createExportWrapper(
        "engine_get_entity_z",
        1
      );
      _engine_get_entity_state = Module["_engine_get_entity_state"] = createExportWrapper(
        "engine_get_entity_state",
        1
      );
...
if (typeof exports === "object" && typeof module === "object") {
  module.exports = BananaEngine;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = BananaEngine;
} else if (typeof define === "function" && define["amd"]) define([], () => BananaEngine);
