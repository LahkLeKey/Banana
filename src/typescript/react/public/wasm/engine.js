...
var _engine_world_spawn = Module['_engine_world_spawn'] = makeInvalidEarlyAccess('_engine_world_spawn');
var _engine_controller_attach = Module['_engine_controller_attach'] = makeInvalidEarlyAccess('_engine_controller_attach');
var _engine_controller_signal = Module['_engine_controller_signal'] = makeInvalidEarlyAccess('_engine_controller_signal');
var _engine_get_entity_count = Module['_engine_get_entity_count'] = makeInvalidEarlyAccess('_engine_get_entity_count');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['engine_world_spawn'] != 'undefined', 'missing Wasm export: engine_world_spawn');
  assert(typeof wasmExports['engine_controller_attach'] != 'undefined', 'missing Wasm export: engine_controller_attach');
  assert(typeof wasmExports['engine_controller_signal'] != 'undefined', 'missing Wasm export: engine_controller_signal');
  assert(typeof wasmExports['engine_get_entity_count'] != 'undefined', 'missing Wasm export: engine_get_entity_count');
  ...
  _engine_world_spawn = Module['_engine_world_spawn'] = createExportWrapper('engine_world_spawn', 4);
  _engine_controller_attach = Module['_engine_controller_attach'] = createExportWrapper('engine_controller_attach', 2);
  _engine_controller_signal = Module['_engine_controller_signal'] = createExportWrapper('engine_controller_signal', 2);
  _engine_get_entity_count = Module['_engine_get_entity_count'] = createExportWrapper('engine_get_entity_count', 0);
