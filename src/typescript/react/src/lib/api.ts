...
export type K3h4ClusterGeometry2d = {
  ...
  readonly centroid: K3h4GeometryPoint2d;
  readonly inscribedRadius: number;
  readonly polygon: readonly K3h4GeometryPoint2d[];
};
...
export type K3h4EpochGeometryResponse = {
  ...
  readonly clusters: readonly K3h4ClusterGeometry2d[];
  readonly tokens: readonly K3h4TokenGeometry2d[];
  readonly projectionMetadata: K3h4ProjectionMetadata;
};
