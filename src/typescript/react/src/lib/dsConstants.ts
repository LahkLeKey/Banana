...
export const RUNTIME_CONTRACTS: RuntimeContractDefinition[] = [
  ...
  },
  {
    ...
    status: "active",
    title: "ipympl",
    summary: "Interactive timeseries cursor/windowing is available as a live notebook surface.",
    detail:
  ...
  },
  {
    ...
    summary: "Zoomable map-like notebook marker surfaces are available directly in the DS page.",
    detail:
  ...
  },
  {
    ...
    summary: "Low-level custom canvas surfaces now render as live animated notebook artifacts.",
    detail:
