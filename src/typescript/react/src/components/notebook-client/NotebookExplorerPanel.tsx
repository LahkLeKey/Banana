...
import { PanelBase, RouteSubActionLink } from '@banana/ui';
    ...
    return (
        <aside style={{ alignSelf: 'start', minWidth: 0, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
            <PanelBase
                ...
                variant="default"
            >
                {/* Tabs: campaign vs dev index */}
                <div style={{ display: 'flex', gap: 6, borderBottom: '1px solid rgba(45, 212, 191, 0.15)', marginBottom: 10, paddingBottom: 8 }}>
                    {['campaign', 'index'].map((tab) => (
                        <button
                            key={tab}
                            type="button"
                            onClick={() => {
                                setActiveTab(tab as 'campaign' | 'index');
                            ...
                            style={{
                                ...
                                cursor: 'pointer',
                                borderBottom: activeTab === tab ? '2px solid #5eead4' : 'none',
                        ...
                        >
                            {tab === 'campaign' ? 'Campaign' : 'Dev Index'}
                        </button>
                    ))}
                </div>
                ...
                <input
                    ...
                    placeholder={activeTab === 'campaign' ? 'Search missions…' : 'Search files…'}
                    style={{
                        width: '100%',
                ...
                {/* Mission overlay — absolute positioned above content */}
