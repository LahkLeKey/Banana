  ...
  return (
    <div className="flex h-10 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3">
      ...
      <button
        ...
        className={`shrink-0 rounded border px-2 py-0.5 text-[11px] font-medium ${RUNTIME_BADGE_CLASS[runtimeState]} ${
          runtimeState === "idle" ? "cursor-pointer hover:opacity-80" : "cursor-default"
        }`}
      >
