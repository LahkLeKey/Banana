  ...
  },
  {
    ...
    cells: [
      ...
      pythonCell(3, "# Surface family outputs\nprint('surfaces_ready')", {
        richOutput: [
          surfaceFixtures.vega,
          surfaceFixtures.altair,
          surfaceFixtures.bokeh,
          surfaceFixtures.widgets,
          surfaceFixtures.ipympl,
          surfaceFixtures.geospatial,
          surfaceFixtures.network,
          surfaceFixtures["three-d"],
          surfaceFixtures.canvas,
        ],
      }),
    ],
  },
