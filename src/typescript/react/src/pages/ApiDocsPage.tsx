    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Interactive Swagger docs embedded in Banana Workspace. Use this to inspect endpoints and
            execute test calls directly.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <Button variant="outline" onClick={() => setSpecUrl(defaultSpecUrl)}>
              Use API Base Default
            </Button>
            <Button variant="outline" asChild>
              <a href="https://api.banana.engineer/swagger" target="_blank" rel="noreferrer">
                Open Raw Swagger UI
              </a>
            </Button>
          </div>
