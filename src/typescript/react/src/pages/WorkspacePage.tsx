...
const modules = [
  ...
  },
  {
    ...
    description:
      "Embedded Jupyter notebook tooling and in-browser Python runtime for production DS workflows.",
    href: "/data-science",
  },
  {
    title: "BananaAI",
    description:
      "Unified assistant combining custom models — Banana Classifier, Ripeness, Not-Banana Detector.",
    href: "/banana-ai",
  },
  {
    title: "Quiz QA",
    description:
      "Benchmark and non-regression quiz checks with human grading over historical model answers.",
    href: "/quiz-qa",
  },
  {
    title: "Operator",
  ...
  },
  {
    title: "Review Spikes",
    description:
      "Scoped research slices: suite IA, knowledge workbench, Functions, BananaAI, and feedback-loop promotion.",
    href: "/review-spikes",
  },
];
    ...
    <div className="space-y-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            banana.engineer — live at{" "}
            <a
              href="https://banana.engineer"
              className="underline"
              target="_blank"
              rel="noreferrer"
            >
            ...
            · API at{" "}
            <a
              href="https://api.banana.engineer"
              className="underline"
              target="_blank"
              rel="noreferrer"
            >
