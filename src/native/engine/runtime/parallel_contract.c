...
static const RuntimeParallelBudget kRuntimeParallelBudgets[] = {
    ...
    {"runtime.controller_sync.update", "src/native/engine/runtime/controller_sync.c", 55, 0.50},
    {"runtime.controller_sync.entity_sync", "src/native/engine/runtime/controller_sync.c", 75, 0.45},
    ...
    {"runtime.physics_abi.sync", "src/native/engine/runtime/physics_abi.c", 39, 0.48},
    ...
    {"runtime.player_motion.integrate", "src/native/engine/runtime/player_motion.c", 52, 0.47},
