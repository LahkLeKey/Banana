...
int main(int argc, char **argv) {
  ...
  banana_terrain_cell_t *cells = (banana_terrain_cell_t *)malloc((size_t)cell_count * sizeof(banana_terrain_cell_t));
  if (!cells) {
  ...
  if (!build_path(palette_path, sizeof(palette_path), config.out_dir, "banana-generated-palette.json") ||
      !build_path(terrain_path, sizeof(terrain_path), config.out_dir, "banana-generated-terrain.json") ||
      !build_path(manifest_path, sizeof(manifest_path), config.out_dir, "banana-generated-assets.manifest.json")) {
    free(cells);
