...
Shader *shader_create(const char *v, const char *f)
{
    (void)v;
    (void)f;
...
void shader_set_vec3(Shader *s, const char *n, float x, float y, float z)
{
    (void)s;
    (void)n;
    (void)x;
...
void shader_set_mat4(Shader *s, const char *n, const float *m)
{
    (void)s;
    (void)n;
    (void)m;
