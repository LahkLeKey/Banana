...
int  window_is_open(Window *w)      { return w && !w->should_close; }
void window_poll_events(Window *w)  { (void)w; /* browser handles events */ }
void window_swap_buffers(Window *w) { (void)w; /* WebGL auto-presents    */ }
