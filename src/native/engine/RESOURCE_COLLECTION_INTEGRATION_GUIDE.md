...
- **Implementation**: `src/native/engine/runtime/interaction/interactive_collection.{h,c}`
- **Implementation**: `src/native/engine/runtime/interaction/interactive_object_spawner.{h,c}`
- **Tests**: `tests/native/player_resources_test.c` (28 tests)
- **Tests**: `tests/native/runtime/interaction/interactive_collection_test.c` (26 tests)
- **Tests**: `tests/native/runtime/interaction/interactive_object_spawner_test.c` (14 tests)
