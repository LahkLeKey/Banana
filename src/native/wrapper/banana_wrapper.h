...
#define BANANA_WRAPPER_ABI_VERSION_MINOR 4
    ...
    /* === Classifier / ML === */
    BANANA_API int banana_predict_banana_regression_score(const char *input_json,
                                                          double *out_score);
    ...
    BANANA_API int banana_classify_banana_binary_with_threshold(const char *input_json,
                                                                double threshold, char **out_json);
     ...
     */
    BANANA_API int banana_classify_banana_transformer_ex(const char *input_json, int log_attention,
    ...
    BANANA_API int banana_add_bunch_to_harvest_batch(const char *batch_id, const char *input_json,
                                                     char **out_json);
    ...
    BANANA_API int banana_load_truck_container(const char *truck_id, const char *input_json,
                                               char **out_json);
    BANANA_API int banana_unload_truck_container(const char *truck_id, const char *container_id,
                                                 char **out_json);
