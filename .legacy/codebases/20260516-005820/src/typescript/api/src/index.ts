...
import {registerTrainingControlPlaneRoutes} from "./domains/training/register.ts";
...
await registerTrainingControlPlaneRoutes(app, {
    enabled :
        (process.env.BANANA_ENABLE_TRAINING_CONTROL_PLANE ?? "false").toLowerCase() === "true",
});
