...
export class GameEngineUIService
{
    ...
    {
        const changed = this.viewportSizer.hasSizeChanged();
        if (changed)
        {
            this.broadcastStateChange();
        }
    ...
    {
        return (s1.engineStatus === s2.engineStatus && s1.error === s2.error &&
                ...
                s1.viewportSize.cssWidth === s2.viewportSize.cssWidth &&
                s1.viewportSize.cssHeight === s2.viewportSize.cssHeight &&
                s1.viewportSize.pixelWidth === s2.viewportSize.pixelWidth &&
                s1.viewportSize.pixelHeight === s2.viewportSize.pixelHeight &&
                s1.viewportSize.devicePixelRatio === s2.viewportSize.devicePixelRatio &&
