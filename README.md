...
- Backlog cleanup targets open issues with labels `triage-idea` or `copilot-suggestion`, and open PRs with labels `automation` + `triaged-item` (or triage branch prefixes).
