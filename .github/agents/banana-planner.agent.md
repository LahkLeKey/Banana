...
agents:
  ...
  - value-risk-prioritization-agent
  - test-triage-agent
handoffs:
  ...
  - label: Prioritize Backlog By Value And Risk
    agent: value-risk-prioritization-agent
    prompt: Score and rank backlog items by value gain, risk reduction, and dependency unlock, then recommend the next incremental slices.
...
- For backlog triage requests, score value gain, dependency unlock, and risk reduction first; avoid scheduling downstream implementation slices ahead of ready foundation blockers.
