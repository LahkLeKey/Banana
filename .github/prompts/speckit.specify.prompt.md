...
description: Create or update a feature specification from natural language requirements.
argument-hint: Describe the feature outcome and user-facing behavior to specify.
agent: speckit.specify
---

Run the Speckit specify workflow.
