...
Incident fields:
- AppID: 4767150
- Beta branch: <fill-from-steamworks>
- Production branch: <fill-from-steamworks>
- Affected depot IDs: <fill-from-steamworks>
- Incident window UTC: <fill-from-steamworks>
- Upload actor IDs: <fill-from-steamworks>
- Publish actor IDs: <fill-from-steamworks>
- Approval policy observed: <fill-from-steamworks>
- Cache invalidation requested at: <fill-from-steamworks>
- Cache invalidation completed at: <fill-from-steamworks>
- Edge propagation notes: <fill-from-steamworks>
