...
| Native engine runtime | Internal native runtime behavior, engine internals, model/runtime integration details | src/native/engine, src/native/k3h4 | src/native/engine/CONTEXT.md | src/native/engine/docs/adr |
