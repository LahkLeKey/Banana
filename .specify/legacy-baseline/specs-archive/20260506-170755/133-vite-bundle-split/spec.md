...
Feature Specification: Vite Bundle Split and Lazy Routes (133) aims to improve system capability and user experience by implementing the feature described in the specification.
