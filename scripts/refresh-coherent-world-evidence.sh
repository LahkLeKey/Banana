...
ctest --test-dir "$BUILD_DIR" -C Debug --output-on-failure -R \
  "banana_(combat_controller_signal|wildlife_controller_war_state|runtime_controller_team_war|runtime_tick_post_phase|runtime_gameplay_warfront_expansion|runtime_tick_orchestration_war_terrain_expansion|runtime_tick_orchestration_war_escalation|runtime_demo_scene_catalog_vector_profile|runtime_demo_scene_catalog_war_policy)_test" \
